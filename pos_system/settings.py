...
SECRET_KEY = 'django-insecure-zo-^ln$3z4_z)m41jh)010+*&cv_c6-7^y3hdjg)(x-eoy2$5b'
...
PROMPTPAY_PHONE = '0834755649'  # ⚠️ เปลี่ยนเป็นเบอร์จริงของร้าน
...
DATABASES = {
    'default': {
        ...
        'USER': 'root',
        'PASSWORD': 'admin123',
        'HOST': 'localhost',  # หรือ IP เครื่องเซิร์ฟเวอร์
